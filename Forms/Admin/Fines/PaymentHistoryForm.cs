        ...
        private void LoadPaymentHistory()
        {
            try
            {
                ...
                dgvPayments.DataSource = payments.Select(p => new
                {
                    ...
                    AmountPaid = Project5LMS.Helpers.IDFormatter.FormatCurrency(p.AmountPaid),
                ...
                dgvAdjustments.DataSource = adjustments.Select(a => new
                {
                    ...
                    OriginalAmount = Project5LMS.Helpers.IDFormatter.FormatCurrency(a.OriginalAmount),
                    AdjustedAmount = Project5LMS.Helpers.IDFormatter.FormatCurrency(a.AdjustedAmount),
                    AdjustmentAmount = Project5LMS.Helpers.IDFormatter.FormatCurrency(a.AdjustmentAmount),
                    Reason = a.Reason ?? "",
